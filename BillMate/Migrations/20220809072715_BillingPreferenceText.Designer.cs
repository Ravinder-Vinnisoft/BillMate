...
namespace BillMate.Migrations
{
    ...
    [Migration("20220809072715_BillingPreferenceText")]
    partial class BillingPreferenceText
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BillMate.Models.BillingPreferences", b =>
                {
                    ...
                    b.Property<string>("BillingPreferenceText")
            ...
            modelBuilder.Entity("BillMate.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BillMate.Models.DentalTotalCollection", b =>
                {
                    b.Property<int>("BillmateReportId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DentalTotalCollections");
                });

            modelBuilder.Entity("BillMate.Models.DentalTotalProduction", b =>
                {
                    b.Property<int>("BillmateReportId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal>("TotIncome")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TotProd")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("DentalTotalProduction");
                });
            ...
            modelBuilder.Entity("BillMate.Models.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BillMate.Models.InvoiceService", b =>
                {
            ...
            modelBuilder.Entity("BillMate.Models.AddressEmployee", b =>
                {
                    b.HasOne("BillMate.Models.Company", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("BillMate.Models.Company", b =>
                {
                    b.HasOne("BillMate.Models.AddressDetails", "AddressDetails")
                        .WithOne("Company")
                        .HasForeignKey("BillMate.Models.Company", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BillMate.Models.User", "User")
                        .WithOne("Company")
                        .HasForeignKey("BillMate.Models.Company", "UserId");
                });
            ...
            modelBuilder.Entity("BillMate.Models.InvoiceService", b =>
                {
                    b.HasOne("BillMate.Models.Invoice", "Invoice")
                        .WithMany("Services")
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BillMate.Models.Service", "Service")
                        .WithMany()
